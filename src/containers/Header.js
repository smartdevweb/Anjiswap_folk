...
const MenuItem = styled.div`
  background: ${props => props.active ? 'linear-gradient(313.34deg, rgba(0, 0, 0, 0.3) -28.92%, rgba(255, 255, 255, 0.3) 130.82%), #4E555D' : ''};
  box-shadow: ${props => props.active ? '-5px -1px 10px rgb(250 251 255 / 20%), 5px 5px 10px #35373E' : ''};
  background-blend-mode: soft-light, normal;
  border-radius: 20px;
  user-select: none;
  width: 60px;
